...
-- Count number of sold item 0.041 sec

SELECT SUM(quantity) 
FROM shopping.sales;

-- Count total price of sold item 0.005 sec

SELECT SUM(total_price) 
FROM shopping.sales;

-- Count price of sold items in the period 0.042 sec
...
-- Count number of item A sold in shop B in C period 0.025 sec
...
-- Count number of item A sold in all shops in C period 0.021 sec
...
-- Count price of sold items in all shops in C period 0.01 sec
...
-- Top 10 sold together by 2 in C period (example, (bread, butter) - 1000 times) 0.041 sec
...
-- Top 10 sold together by 3 in C period (example, (bread, butter, milk) - 1000 times) 0.154 sec
...
-- Top 10 sold together by 4 in C period 1.7 sec
